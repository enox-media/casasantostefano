...
var myPlaylist = [
    
  {
      /*Question 1*/
    type: "youtube",
    title: "Honest, Innovative, Family-Oriented Dental Team",
    author: "Curry Leavitt, DMD",
    sources: [{
      src: "sGk6MHx84Qw",
      type: "youtube"
    }],
    src: "sGk6MHx84Qw",
    poster: "https://img.youtube.com/vi/sGk6MHx84Qw/hqdefault.jpg"
  },
  {
      /*Question 2*/
    type: "youtube",
    title: "Treat Gummy Smiles with Immediate Results",
    author: "Curry Leavitt, DMD",
    sources: [{
      src: "ZJwfn7EHTIs",
      type: "youtube"
    }],
    poster: "https://img.youtube.com/vi/ZJwfn7EHTIs/hqdefault.jpg"
  },
  {
      /*Question 3*/
    type: "youtube",
    title: "PST Is the Minimally Invasive Gum Recession Treatment",
    author: "Curry Leavitt, DMD",
    sources: [{
      src: "https://www.youtube.com/watch?v=S19WM_sJeE4",
      type: "youtube"
    }],
    poster: "https://img.youtube.com/vi/S19WM_sJeE4/hqdefault.jpg"
  },
  {
      /*Question 4*/
    type: "youtube",
    title: "Negative Effects of Periodontal Disease",
    author: "Curry Leavitt, DMD",
    sources: [{
      src: "https://www.youtube.com/watch?v=eRmBpCzXd4A",
      type: "youtube"
    }],
    poster: "https://img.youtube.com/vi/eRmBpCzXd4A/hqdefault.jpg"
  },
  {
      /*Question 5*/
    type: "youtube",
    title: "Replace Missing Teeth and Change Your Life",
    author: "Curry Leavitt, DMD",
    sources: [{
      src: "https://www.youtube.com/watch?v=qjvGQYptRfU",
      type: "youtube"
    }],
    poster: "https://img.youtube.com/vi/qjvGQYptRfU/hqdefault.jpg"
  },
  {
      /*Question 6*/
    type: "youtube",
    ...
    author: "Curry Leavitt, DMD",
    sources: [{
      src: "https://www.youtube.com/watch?v=EhQM5qOj3_k",
      type: "youtube"
    }],
    poster: "https://img.youtube.com/vi/EhQM5qOj3_k/hqdefault.jpg"
  },
  {
      /*Question 7*/
    type: "youtube",
    title: "The Ease of Dental Implant Procedures",
    author: "Curry Leavitt, DMD",
    sources: [{
      src: "https://www.youtube.com/watch?v=N1gbgd_ZEXc",
      type: "youtube"
    }],
    poster: "https://img.youtube.com/vi/N1gbgd_ZEXc/hqdefault.jpg"
  }
...
function getTYPlaylist(playlistId, apikey, limit) {
  ...
  function PlyrPlaylist(target, myPlaylist, limit) {
    $('<div class="plyr-playlist-wrapper"><div class="title-interview col-sm-11 offset-sm-1"><h2 class="border-3px-left " style="color: white;">Meet The Doctor</h2></div><ul class="plyr-playlist"></ul></div>').insertAfter("#player");
