...
include_function('kirki-installer');
...
/**
 * Connect to WP-Updates.com
 */
require_once('wp-updates.php');
new WPUpdatesThemeUpdater_2760( 'http://wp-updates.com/api/2/theme', basename( get_template_directory() ) );


/*
 * Version 2.7 - Schema Pro Custom Fields
 *
 * Change Log:
 *
 * Added the listing description field to the schema
 *
 *
 * Start of the custom function necessary to integrate the geo-coordinates into the Schema Plugin
 *  - Guru Urulurulru C.U.
 *
 *
 *
